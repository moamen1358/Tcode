...
Provides: GTK **4.14.5** (`gtk4.pc`), VTE **0.76.0** (`vte-2.91-gtk4.pc`), C toolchain, pkg-config.
...
```bash
cargo test -p tessera-core      # pure-logic unit tests — 11 passing
...
The runtime image installs only: `libgtk-4-1 libvte-2.91-gtk4-0 fonts-dejavu-core
